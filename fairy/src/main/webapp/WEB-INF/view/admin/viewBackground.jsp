...
<style>
    td.details-control {
    background: url('adminResources/images/details_open.png') no-repeat center center;
    cursor: pointer;
}
    tr.shown td.details-control {
        background: url('adminResources/images/details_close.png') no-repeat center center;
    }
</style>
</head>
...
<div class="page-loader-wrapper">
    <div class="loader">
        <div class="m-t-30"><img src="adminResources/images/logo-icon.svg" width="48" height="48" alt="Lucid"></div>
        <p>Please wait...</p>        
    </div>
</div>
...
<div id="wrapper">
   ...
   <%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
          ...
          <c:forEach items="${backgroundList}" var="i" varStatus="j" >                           
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>${i.backgroundName}</td>
  										<td><img src="<%=request.getContextPath()%>/document/background/${i.backgrounFileName}" style="height: 250px;width: 400px;"></td>
  										
                                        <td class="actions">
                                            
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-edit"
                                            	data-toggle="tooltip" data-original-title="Edit">
                                            	<a href="editBackground?BackgroundId=${i.id}"><i class="icon-pencil" aria-hidden="true"></i></a>
                                            </button>
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                            	data-toggle="tooltip" data-original-title="Remove">
                                            	<a href="deleteBackground?BackgroundId=${i.id}"><i class="icon-trash" aria-hidden="true"></i></a>
                                            </button>
                                        </td>
                                     </tr>
                                </tbody>
