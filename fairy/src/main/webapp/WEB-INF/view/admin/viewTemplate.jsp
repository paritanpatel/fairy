            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <i class="fa fa-arrow-left"></i></a> View Template</h2>
                        <ul class="breadcrumb">
	...
	<%@taglib prefix="c" uri="http://java.sun.com/jstl/core_rt" %>
                        <div class="body">
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <c:forEach items="${templateList}" var="i" varStatus="j">
                                <tbody>
                                 <tr>
                                        ...
                                        <td class="actions">
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default m-r-5 button-edit"
                                            	...
                                            	<a href="editTemplate?templateId=${i.id}"><i class="icon-pencil" aria-hidden="true"></i></a>
                                            </button>
                                            <button class="btn btn-sm btn-icon btn-pure btn-default on-default button-remove"
                                            	data-toggle="tooltip" data-original-title="Remove">
                                            	<a href="deleteTemplate?templateId=${i.id}"><i class="icon-trash" aria-hidden="true"></i></a>
                                            </button>
                                        </td>
                                     </tr>
                                </tbody>
