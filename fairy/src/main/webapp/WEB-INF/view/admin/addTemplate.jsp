            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Manage Template</h2>
                        <ul class="breadcrumb">
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <f:form id="basic-form" method="post" action="insertTemplate" modelAttribute="TemplateVO" >
                                ...
                                <div class="form-group">
                                    ...
                                    <f:input type="text" path="templateName" class="form-control" required="required"/>
                                </div>

                                <div class="form-group">
                                    <label>Rows</label>
                                    <f:input type="text" path="rows" class="form-control" required="required"/>
                                </div>
                                
                                <div class="form-group">
                                    <label>Columns</label>
                                    <f:input type="text" path="columns" class="form-control" required="required"/>
                                </div>
