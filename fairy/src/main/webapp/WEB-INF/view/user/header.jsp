...
<nav class="edgtf-main-menu edgtf-drop-down edgtf-default-nav">
						<ul id="menu-main-menu" class="clearfix">
							...
							<li id="nav-menu-item-598"
								...
								href="#" class="edgtf-no-link" style="cursor: default;"
								onclick="JavaScript: return false;"><span
									class="edgtf-item-outer"><span class="edgtf-item-inner"><span
											class="edgtf-item-text">Background</span></span><span class="plus"></span></span></a>
							...
							<li id="nav-menu-item-598"
								...
								onclick="JavaScript: return false;"><span
									class="edgtf-item-outer"><span class="edgtf-item-inner"><span
											class="edgtf-item-text">Character</span></span><span class="plus"></span></span></a>
								<div class="edgtf-menu-second">
									<div class="edgtf-menu-inner">
										<ul>
											<li id="nav-menu-item-601"
												class="menu-item menu-item-type-post_type menu-item-object-page edgtf-wide-background"><a
												href="loadUserCharacter.html"><span
													class="edgtf-item-outer"><span
														class="edgtf-item-inner"><span
															class="edgtf-item-text">Post Character</span></span><span
														class="plus"></span></span></a></li>
											<li id="nav-menu-item-601"
												class="menu-item menu-item-type-post_type menu-item-object-page edgtf-wide-background"><a
							...
							<li id="nav-menu-item-603"
								class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children edgtf-has-sub edgtf-menu-narrow edgtf-wide-background"><a
								href="searchUserCategory.html" class="edgtf-no-link"
								style="cursor: default;"><span class="edgtf-item-outer"><span
										class="edgtf-item-inner"><span class="edgtf-item-text">Create
...
<li id="nav-menu-item-598"
							...
							<li id="nav-menu-item-598"
								...
								onclick="JavaScript: return false;"><span
									class="edgtf-item-outer"><span class="edgtf-item-inner"><span
											class="edgtf-item-text">Manage Profile</span></span><span
								...
								style="cursor: default;"><span class="edgtf-item-outer"><span
										class="edgtf-item-inner"><span class="edgtf-item-text">Logout
